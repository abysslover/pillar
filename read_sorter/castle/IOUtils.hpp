...
#include <read_sorter/castle/BinaryEncoder.hpp>
#include <read_sorter/castle/ParallelRunner.hpp>
...
public:
	...
	static void combine_intermediate_files(const std::string& file_suffix, const int64_t max_block_id);
	static void remove_intermediate_files(const std::string& file_suffix, const int64_t max_block_id, const int64_t n_cores);
